...
/**
 * A voice that can be synchronized from an outside timing source. Useful for
 * e.g. audio playback to be synchronized with a sequencer.
 *
...
public abstract class SynchronizedVoice extends Voice {
    ...
    /**
     * Construct a new Synchronized Voice. Note that in order for the

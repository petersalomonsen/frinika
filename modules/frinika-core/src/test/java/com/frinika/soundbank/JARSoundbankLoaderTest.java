...
public class JARSoundbankLoaderTest {
    ...
    private void createSoundbank(String testSoundbankFileName) throws Exception {
        ...
        if (packageDir.exists()) {
            ...
            Assert.assertTrue(packageDir.delete());
        }
        packageDir.mkdir();
    ...
    public void testGetTempSoundbankFile() throws Exception {
        ...
        Assert.assertTrue(result.getAbsolutePath().startsWith(System.getProperty("java.io.tmpdir") + "/" + testSoundbankFilename.replace(".jar", "")));
    ...
    public void testJARSoundbankReload() throws Exception {
        ...
        for (int n = 0; n < 10; n++) {
            ...
            Assert.assertEquals((expectedVersion++) + "", sb.getVersion());
        }

...
/**
 * Implements a thread safe circular buffer of commands with appropriate notify
...
public class CommandList {
    ...
    public static final int NOTE_ON = 1, // Command code for note on
            NOTE_OFF = 2;               // Command code for note off

    // Local constants
    private static final int MAX_COMMAND_LIST = 32;      // Max number of stored commands

    // Pointers and data counter
    private int putPointer, // Pointer to last command in list
    ...
    /**
     * Get the next command type and note from the buffer. It is assumed that
     * waitForCommand has been called prior to this method so that it is known
     * that there is data waiting to be taken
     */

...
/**
 * Class to store an arbitrary number of graph points in a vector and provide
 * fifo access to its elements
 */

public class GraphPointVector {

    private Vector v;                          // Vector to store the points
    private int count, // size of vector

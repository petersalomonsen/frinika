...
public class SamplerGUI extends JFrame implements InstrumentNameListener {
    ...
    public SamplerGUI(final MySampler sampler) {
        ...
        if (sampler.getAudioOutput() instanceof JavaSoundVoiceServer) {
            JMenu audioInputMenu = new JMenu(CurrentLocale.getMessage("sampler.menu.audio_inputs"));
...
//		    }  
    ...
    void startSampler() {
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(SamplerGUI.this, CurrentLocale.getMessage("sampler.menu.audio_input_error"));
        }
    }

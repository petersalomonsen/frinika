 ...
 * Collaborates with a BufferedRandomAccessFileManager. This should be used to
 * prefetch data and avoid disk seek glitches
 *
 *
...
public class BufferedRandomAccessFile implements RandomAccessFileIF {
    ...
    /**
     * Called from the thread filling buffer. Makes sure audio thread is not
     * using buffer.
     *
     */

...
/**
 * GUI component which is a JSlider with a number-field (JSpinner) attached to
 * it. This way, numerical values can be edited either "visually" (using the
 * slider) or "precise" entering the number textually. Slider and umber-field
 * are always in sync.
 *
 * @author Jens Gulden
 */

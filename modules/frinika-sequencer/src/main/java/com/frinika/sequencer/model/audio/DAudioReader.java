...
/**
 * Wraps up a wav file and allows access using a RandomAccessFile. provides a
...
//					+ " " + format.getFrameSize());
     ...
     *
     *
     * @param framePos frame postition reltive to start of audio. e.g. zero is
     * start of audio.
     *
     * @throws IOException
     */
     ...
     *
     * @param byteBuffer buffer to fill
     * @param offSet offset into byteBuffer

...
public class MidiSequenceConverter {
     ...
     * All tracks are split up so that there is only one channel represented per
     * track. Tracks are mapped to channel in ascending channel order, and the
     * initial track is left as a mastertrack (containing tempo events etc.)
     */
